...
import { WorkSettings, OfferSettings, DashboardLayout, WidgetVisibility, SavedRotation, StatusItem, Shift, ThemeSettings, WorkLocation } from '../types';
...
const SettingsPage: React.FC = () => {
    ...
    const { allDayInfo, showToast } = useData();
