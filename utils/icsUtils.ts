 ...
 * @param end The end date/time of the event (for timed events).
...
export const generateSingleEventICS = (
    ...
    let event: string[];
    if (isAllDay) {
        // For all-day events, the end date is exclusive, so we use the next day.
...
export const generateICS = (
    ...
    while (currentDate <= endDate) {
        ...
        // Handle Leave or Shift (all-day events)
